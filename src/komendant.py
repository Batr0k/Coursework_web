...
from src.schemas.schemas import OccupantPostDTO, OccupantGetDTO
router = APIRouter(prefix="/komendant")
templates = Jinja2Templates(directory= "templates")
from src.orm.komendant_orm import select_all_occupant, add_occupant, get_occupant, update_occupant, select_rooms, select_furniture, select_free_rooms
